...
function Menu() {
  ...
  return (
    <main className="menu">
      ...
      {pizzas.length > 0 ? ( // below <> could also be <React.Fragment> when key attribute is needed, e.g. for lists
        <>
          <p>
  ...
  return (
    <footer className="footer">
      {isOpen ? (
        ...
        <p>We're closed. Come back tomorrow from {formatFullHour(openHour)}</p>
      )}
    </footer>
  );
}
